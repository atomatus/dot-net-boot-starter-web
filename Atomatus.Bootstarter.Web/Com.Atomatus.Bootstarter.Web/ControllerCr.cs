...
namespace Com.Atomatus.Bootstarter.Web
{
    ...
    /// <para>
    /// ┌[C]reate:<br/>
    /// └─► <see cref="ControllerCr{TService, TModel}.Create(TModel)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[R]ead:<br/>
    /// ├─► <see cref="ControllerCr{TService, TModel}.Get()"/><br/>
    /// ├─► <see cref="ControllerCr{TService, TModel}.Get(Guid)"/><br/>
    /// └─► <see cref="ControllerCr{TService, TModel}.Paging(int, int)"/>
    /// </para>
    /// </summary>
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCr<TModel> : ControllerCr<IServiceCrud<TModel>, TModel>
        where TModel : IModel
    {
        /// <summary>
        ...
        protected ControllerCr(IServiceCrud<TModel> service, ILogger<ControllerCr<TModel>> logger) : base(service, logger) { }
        ...
        /// </summary>
        /// <param name="service">service to data persistence</param>
        protected ControllerCr(IServiceCrud<TModel> service) : base(service) { }
    }
    ...
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCr<TService, TModel> : ControllerCrudBase<TService, TModel>
        ...
        where TModel : IModel
    {
        ...
        /// <param name="service">service to data persistence</param>
        /// <param name="logger">logging target</param>
        protected ControllerCr(TService service, ILogger<ControllerCr<TService, TModel>> logger) : base(service, logger) { }
