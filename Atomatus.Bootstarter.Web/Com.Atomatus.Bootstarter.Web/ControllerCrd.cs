...
namespace Com.Atomatus.Bootstarter.Web
{
    ...
    /// <para>
    /// ┌[C]reate:<br/>
    /// └─► <see cref="ControllerCrd{TService, TModel}.Create(TModel)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[R]ead:<br/>
    /// ├─► <see cref="ControllerCrd{TService, TModel}.Get()"/><br/>
    /// ├─► <see cref="ControllerCrd{TService, TModel}.Get(Guid)"/><br/>
    /// └─► <see cref="ControllerCrd{TService, TModel}.Paging(int, int)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[D]elete:<br/>
    /// └─► <see cref="ControllerCrd{TService, TModel}.Delete(Guid)"/>
    /// </para>
    /// 
    /// </summary>
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCrd<TModel> : ControllerCrd<IServiceCrud<TModel>, TModel>
        where TModel : IModel
    {
        /// <summary>
        ...
        protected ControllerCrd(IServiceCrud<TModel> service, ILogger<ControllerCrd<TModel>> logger) : base(service, logger) { }
        ...
        /// </summary>
        /// <param name="service">service to data persistence</param>
        protected ControllerCrd(IServiceCrud<TModel> service) : base(service) { }
    }
    ...
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCrd<TService, TModel> : ControllerCrudBase<TService, TModel>
        ...
        where TModel : IModel
    {
        ...
        /// <param name="service">service to data persistence</param>
        /// <param name="logger">logging target</param>
        protected ControllerCrd(TService service, ILogger<ControllerCrd<TService, TModel>> logger) : base(service, logger) { }
