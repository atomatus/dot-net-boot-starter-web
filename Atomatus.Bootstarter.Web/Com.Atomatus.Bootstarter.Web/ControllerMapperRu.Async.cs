...
{
    /// <summary>
    /// Versioned Controller [R]ead and [U]pdate operation implementation for entity model protected by DTO pattern using service.
    /// <para>
    ...
    /// <para>
    /// ┌[R]ead:<br/>
    /// ├─► <see cref="ControllerMapperRuAsync{TService, TModel, TDtoIn, TDtoOut}.GetAsync(CancellationToken)"/><br/>
    /// ├─► <see cref="ControllerMapperRuAsync{TService, TModel, TDtoIn, TDtoOut}.GetAsync(Guid)"/><br/>
    /// └─► <see cref="ControllerMapperRuAsync{TService, TModel, TDtoIn, TDtoOut}.PagingAsync(int, int, CancellationToken)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[U]pdate:<br/>
    /// └─► <see cref="ControllerMapperRuAsync{TService, TModel, TDtoIn, TDtoOut}.UpdateAsync(TDtoIn)"/>
    /// </para>
    /// 
    /// </summary>
    ...
    public abstract class ControllerMapperRuAsync<TModel, TDtoIn, TDtoOut> : ControllerMapperRuAsync<IServiceCrudAsync<TModel>, TModel, TDtoIn, TDtoOut>
        ...
        where TDtoOut : class, new()
    {
        ...
        protected ControllerMapperRuAsync(IServiceCrudAsync<TModel> service, ILogger<ControllerMapperRuAsync<TModel, TDtoIn, TDtoOut>> logger) : base(service, logger) { }
        ...
        /// </summary>
        /// <param name="service">service to data persistence</param>
        protected ControllerMapperRuAsync(IServiceCrudAsync<TModel> service) : base(service) { }
    }

    /// <summary>
    /// Versioned Controller [R]ead and [U]pdate operation implementation for entity model protected by DTO pattern and using service.
    /// <para>
    /// This controller constains by default the following actions:<br/><br/>
    /// </para>
    /// 
    ...
    /// <typeparam name="TDtoIn">dto input type, accepted in creation action body</typeparam>
    /// <typeparam name="TDtoOut">dto output type, generated after creation or read operation successfully</typeparam>
    public abstract class ControllerMapperRuAsync<TService, TModel, TDtoIn, TDtoOut> : ControllerMapperCrudBaseAsync<TService, TModel>
        ...
        where TDtoOut : class, new()
    {
        ...
        /// <param name="service">service to data persistence</param>
        /// <param name="logger">logging target</param>
        protected ControllerMapperRuAsync(TService service, ILogger<ControllerMapperRuAsync<TService, TModel, TDtoIn, TDtoOut>> logger) : base(service, logger) { }
        ...
        /// </summary>
        /// <param name="service">service to data persistence</param>
        protected ControllerMapperRuAsync(TService service) : base(service) { }
