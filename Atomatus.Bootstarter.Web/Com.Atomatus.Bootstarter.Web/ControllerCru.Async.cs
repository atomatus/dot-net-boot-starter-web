...
namespace Com.Atomatus.Bootstarter.Web
{
    ...
    /// <para>
    /// ┌[C]reate:<br/>
    /// └─► <see cref="ControllerCruAsync{TService, TModel}.CreateAsync(TModel)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[R]ead:<br/>
    /// ├─► <see cref="ControllerCruAsync{TService, TModel}.GetAsync(CancellationToken)"/><br/>
    /// ├─► <see cref="ControllerCruAsync{TService, TModel}.GetAsync(Guid)"/><br/>
    /// └─► <see cref="ControllerCruAsync{TService, TModel}.PagingAsync(int, int, CancellationToken)"/>
    /// </para>
    /// 
    /// <para>
    /// ┌[U]pdate:<br/>
    /// └─► <see cref="ControllerCruAsync{TService, TModel}.UpdateAsync(TModel)"/>
    /// </para>
    /// 
    /// </summary>
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCruAsync<TModel> : ControllerCruAsync<IServiceCrudAsync<TModel>, TModel>     
        where TModel : IModel
    {
        /// <summary>
        ...
        protected ControllerCruAsync(IServiceCrudAsync<TModel> service, ILogger<ControllerCruAsync<TModel>> logger) : base(service, logger) { }
        ...
        /// </summary>
        /// <param name="service">service to data persistence</param>
        protected ControllerCruAsync(IServiceCrudAsync<TModel> service) : base(service) { }
    }
    ...
    /// <typeparam name="TModel">entity model type</typeparam>
    public abstract class ControllerCruAsync<TService, TModel> : ControllerCrudBaseAsync<TService, TModel>
        ...
        where TModel : IModel
    {
        ...
        /// <param name="service">service to data persistence</param>
        /// <param name="logger">logging target</param>
        protected ControllerCruAsync(TService service, ILogger<ControllerCruAsync<TService, TModel>> logger) : base(service, logger) { }
